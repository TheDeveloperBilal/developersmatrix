          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="flex-1">
              ...
              <section className="mb-12">
                ...
                <div className="prose dark:prose-invert max-w-none text-gray-700 dark:text-gray-300 space-y-4">
                  <p className="leading-relaxed">
                    Keep a tech cover letter between 250 and 400 words. Recruiters skim on the first pass, so every sentence must earn its place. Here are the four elements that separate cover letters that get callbacks from those that get ignored.
                  </p>
