      ...
      <div className="p-6 border-b border-slate-200 dark:border-slate-700">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <TooltipProvider>
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button onClick={onCopy} variant="outline" size="sm" className="border-slate-200 dark:border-slate-700 hidden sm:flex items-center gap-2">
            ...
            <Button 
              onClick={onExportPDF} 
              className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white shadow-lg shadow-blue-500/25 px-4 py-2 rounded-lg flex items-center gap-2 text-sm font-medium"
            >
            ...
            <TooltipProvider>
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button onClick={onClear} variant="outline" size="icon" className="border-slate-200 dark:border-slate-700 hidden sm:flex">
                    <X className="w-4 h-4" />
                  </Button>
                </TooltipTrigger>
