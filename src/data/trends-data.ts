...
export const allTrends: TrendItem[] = [
  ...
  // AI Agents
  {
    ...
    content: {
      ...
      whoShouldRead: 'Developers exploring agent architecture, entrepreneurs seeking automation opportunities, business owners evaluating AI adoption, and tech professionals preparing for the next wave of AI should start here.',
