...
// Read content files and add them
const contentDir = './src/data/blog-content';
for (const post of posts) {
  const contentPath = `${contentDir}/${post.slug}.md`;
...
fs.writeFileSync('./src/data/high-quality-blogs.json', JSON.stringify(posts, null, 2));
console.log('Created high-quality-blogs.json with', posts.length, 'posts');
